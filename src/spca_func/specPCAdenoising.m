...
% adapted by Jacob Salminen, University of Florida, Janruary 2025
% v1.0 last changed 01/30/2025
%% ===================================================================== %%
%-- check whether eigenvalues are provided, if not calculate from data   
if isempty(varargin) % PCA of ERSP --> dim = num freqs
    if size(ERSP,1) == 1
...
%(01/30/2025) JS, made adaptations to accomodate PSD data.

%-- take inverse of unmixing matrix V to get mixing matrix Ai
Ai = V.'; 
%(01/30/2025) Anon (JS), transpose is quicker than inv() and sufficient 
% since V vectors are orthogonal
