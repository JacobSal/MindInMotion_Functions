...
for IC = 1:size(cov_matrix,3)
    ...
    lowfreq_coupling{IC}=cov_matrix(freqs<LOW_FREQ,freqs<LOW_FREQ,IC); %below alpha
    highfreq_coupling{IC}=cov_matrix(freqs>HIGH_FREQ,freqs>HIGH_FREQ,IC); %above beta
