...
#SBATCH --output=/blue/dferris/jsalminen/GitHub/par_EEGProcessing/src/1_PREPROC/mim/_compiled/mcc_dipfit/_slurm_logs/%j_mcc_dipfit_compile.log # Standard output
