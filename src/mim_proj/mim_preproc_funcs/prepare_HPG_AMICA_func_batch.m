function [txt] = prepare_HPG_AMICA_func_batch(EEG,fileNameNoExt,amicaOutputFolder_local,...
...
AMICAdir_local = fullfile(amicaOutputFolder_local);

% AMICAdir_unix = ['/blue/dferris/share/MindInMotion/Data/',subj,'/EEG/AMICA/',num2str(subDirNum),'/'];
AMICAdir_unix = [amicaOutputFolder_unix,'/'];
